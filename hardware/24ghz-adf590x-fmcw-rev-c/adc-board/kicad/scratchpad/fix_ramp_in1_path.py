...
def remove_old(text: str) -> str:
    ...
    for match in list(SEGMENT_RE.finditer(text)):
        if match.group(7) == "RAMP_SYNC":
            ...
            removed += 1
    if removed != 5:
        raise RuntimeError(f"expected 5 RAMP_SYNC segments, removed {removed}")
    return text
...
def main() -> int:
    if len(sys.argv) != 2:
        print("usage: fix_ramp_in1_path.py <board.kicad_pcb>", file=sys.stderr)
        return 2

    board = Path(sys.argv[1])
    routes = [
        segment((6.95, 38.89), (18.0, 38.89)),
        segment((18.0, 38.89), (18.0, 18.5)),
        segment((18.0, 18.5), (37.5, 18.5)),
        segment((37.5, 18.5), (37.5, 16.0)),
        segment((37.5, 18.5), (44.0, 18.5)),
        segment((44.0, 18.5), (44.0, 26.0)),
        segment((44.0, 26.0), (48.26, 27.32)),
    ]
